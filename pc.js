...
/*** 请填写以下配置信息 ***/
const APPID = '2021001157638209';  //https://open.alipay.com 账户中心->密钥管理->开放平台密钥，填写添加了电脑网站支付的应用的APPID
const RETURN_URL = 'https://www.dedemao.com/alipay/return.php';     //付款成功后的同步回调地址
const NOTIFY_URL = 'https://www.dedemao.com/alipay/notify_redis.php';     //付款成功后的异步回调地址
